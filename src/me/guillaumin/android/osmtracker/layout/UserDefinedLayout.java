...
public class UserDefinedLayout extends LinearLayout {
	...
	public UserDefinedLayout(TrackLogger activity, File xmlLayout) throws XmlPullParserException, IOException {
		...
		if (xmlLayout == null) {
			...
			udlr = new UserDefinedLayoutReader(this, getContext(), activity, parser, new ExternalDirectoryIconResolver(xmlLayout.getParentFile(), ExternalDirectoryIconResolver.EXTENSION_PNG));
		}
